...
// clang-format off
#ifndef LMP_ATOM_VEC_X0_IMAGE_KOKKOS_H
#define LMP_ATOM_VEC_X0_IMAGE_KOKKOS_H
...
class AtomVecX0ImageKokkos : public AtomVecKokkos, public AtomVecX0Image {
 public:
  AtomVecX0ImageKokkos(class LAMMPS *);
