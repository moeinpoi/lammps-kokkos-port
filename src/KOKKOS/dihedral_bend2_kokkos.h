...
// clang-format off
DihedralStyle(bend2/kk,DihedralBend2Kokkos<LMPDeviceType>);
DihedralStyle(bend2/kk/device,DihedralBend2Kokkos<LMPDeviceType>);
DihedralStyle(bend2/kk/host,DihedralBend2Kokkos<LMPHostType>);
// clang-format on
#else
...
struct TagDihedralBend2Compute{};

template<class DeviceType>
class DihedralBend2Kokkos : public DihedralBend2 {
 public:
  typedef DeviceType device_type;
  typedef EV_FLOAT value_type;
  typedef ArrayTypes<DeviceType> AT;

  DihedralBend2Kokkos(class LAMMPS *);
  ~DihedralBend2Kokkos() override;
  ...
  void operator()(TagDihedralBend2Compute<NEWTON_BOND,EVFLAG>, const int&, EV_FLOAT&) const;

  template<int NEWTON_BOND, int EVFLAG>
  KOKKOS_INLINE_FUNCTION
  void operator()(TagDihedralBend2Compute<NEWTON_BOND,EVFLAG>, const int&) const;
