...
#ifdef ATOM_CLASS
// clang-format off
AtomStyle(sph/kk,AtomVecSPHKokkos);
AtomStyle(sph/kk/device,AtomVecSPHKokkos);
AtomStyle(sph/kk/host,AtomVecSPHKokkos);
// clang-format on
#else

// clang-format off
#ifndef LMP_ATOM_VEC_SPH_KOKKOS_H
#define LMP_ATOM_VEC_SPH_KOKKOS_H
...
class AtomVecSPHKokkos : public AtomVecKokkos, public AtomVecSPH {
 public:
  AtomVecSPHKokkos(class LAMMPS *);
